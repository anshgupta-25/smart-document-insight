...
function generateMarkdownReport(
  ...
  lines.push(`# 📄 Document Intelligence Report`);
  lines.push(`**Document:** ${fileName || "Unknown"}`);
  lines.push(`**Generated:** ${date}`);
  lines.push(`**Platform:** DocIntel Enterprise AI`);
  lines.push("");
  ...
  if (summaries.length > 0) {
    ...
    summaries.forEach((section) => {
      ...
      const statusIcon = section.verificationStatus === "verified" ? "✅" : section.verificationStatus === "conflict" ? "❌" : "⚠️";
  ...
  lines.push("---");
  lines.push(`*Report generated by DocIntel Enterprise AI Platform*`);
